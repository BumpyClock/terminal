...
#pragma endregion
        ...
        BUBBLED_FORWARDED_TYPED_EVENT(ShellContextChanged,      IInspectable, Control::ShellContextEventArgs);
    ...
    private:
        ...
        struct Revokers
        {
            ...
            Control::ControlCore::ShellContextChanged_revoker ShellContextChanged;
